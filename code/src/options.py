...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--desired-saturation', type=float, default='0.5', help='desired saturation for discriminator (training)')
        parser.add_argument('--desired-hue', type=float, default='1', help='desired hue for discriminator (training)')
        parser.add_argument('--desired-red', type=float, default='1', help='desired red for discriminator (training)')
        parser.add_argument('--desired-green', type=float, default='1', help='desired green for discriminator (training)')
        parser.add_argument('--desired-blue', type=float, default='1', help='desired blue for discriminator (training)')
        parser.add_argument('--saturation-weight', type=float, default='1', help='weight for saturation loss for discriminator (training)')
        parser.add_argument('--hue-weight', type=float, default='0', help='weight for hue loss for discriminator (training)')
        parser.add_argument('--red-weight', type=float, default='0', help='weight for red loss for discriminator (training)')
        parser.add_argument('--green-weight', type=float, default='0', help='weight for green loss for discriminator (training)')
        parser.add_argument('--blue-weight', type=float, default='0', help='weight for blue loss for discriminator (training)')

        self._parser = parser

    def parse(self):
        opt = self._parser.parse_args()
        opt.desired_saturation = opt.desired_saturation
        opt.desired_hue = opt.desired_hue
        opt.saturation_weight = opt.saturation_weight
        opt.hue_weight = opt.hue_weight
